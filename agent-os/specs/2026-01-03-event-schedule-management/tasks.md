...
- [ ] 1.0 Complete database layer
  - [ ] 1.1 Write 2-8 focused tests for Course and Event models
  ...
  - [ ] 1.2 Create Course model and migration
  ...
  - [ ] 1.4 Update Event model and create migration
  ...
  - [ ] 1.5 Create event_user pivot table for registrations
...
- [ ] 2.0 Complete Admin UI
  - [ ] 2.1 Write 2-8 focused tests for Filament Resources
    - Limit to 2-8 highly focused tests maximum
